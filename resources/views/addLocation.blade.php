    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="{{ url('add-location') }}">
              @csrf
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="location-name" class="form-control col-md-7 col-xs-12" name="name" value="{{ old('name') }}" placeholder="Enter Location / Workshop Name">
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="location-slug" class="form-control col-md-7 col-xs-12" name="slug" value="{{ old('slug') }}" placeholder="Auto generated from name" readonly style="background-color:#eee; cursor:not-allowed;">
                </div>
                <div class="col-md-3 col-sm-3 col-xs-12">
                  @error('slug')
                    <span class="form-control-feedback" style="position:static; display:inline-block; height:auto; width:auto;">{{ $message }}</span>
